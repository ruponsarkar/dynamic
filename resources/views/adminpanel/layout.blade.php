            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" data-enable-remember="true" href="#"
                        role="button"><i class="feather icon-maximize"></i></a>
                </li>
        ...
        <aside class="main-sidebar sidebar-dark-gray elevation-4 ">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ url('admin/assets/img/avatar5.png') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a href="{{ URL('admin_index') }}" class="d-block text-decoration-none">Admin Panel</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="{{ URL('admin_index') }}"
                                class="nav-link  {{ request()->is('admin_index') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ URL('all-manuscript') }}"
                                class="nav-link {{ request()->is('all-manuscript') ? 'active' : '' }}">
                        ...
                        {{-- <li class="nav-item">
                            <a href="{{ URL('receive-editors') }}"
                                class="nav-link {{ request()->is('receive-editors') ? 'active' : '' }}">
                        ...
                        <li
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ URL('journalForm') }}"
                                        class="nav-link {{ request()->is('journalForm') ? 'active' : '' }}">
                                        <p class="p-4"><i class="fas fa-arrow-right"></i> Edit Journals</p>
                                    </a>
                                </li>
                                {{-- <li class="nav-item">
                  <a href="#" class="nav-link">
                    <p class="p-4"><i class="fas fa-arrow-right"></i> Update Journals</p>
                        ...
                        <li
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ URL('addEditors') }}"
                                        class="nav-link {{ request()->is('addEditors') ? 'active' : '' }}">
                        ...
                        <li
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ URL('add-volume') }}"
                                        class="nav-link {{ request()->is('add-volume') ? 'active' : '' }}">
            ...
            <p>
              Home page Article
                        ...
                        <li class="nav-item">
                            <a href="{{ URL('manege-pages') }}"
                                class="nav-link {{ request()->is('manege-pages') ? 'active' : '' }}">
                        ...
                        {{-- <li class="nav-item">
                            <a href="{{ URL('newsUpdation') }}"
                                class="nav-link {{ request()->is('newsUpdation') ? 'active' : '' }}">
                                <i class="nav-icon fas fa-book"></i>
                                <p>
                                    News & Updation
                                </p>
                        ...
                        {{-- <li
                            class="nav-item has-treeview {{ request()->is('custom_pages/*') ? 'menu-is-opening menu-open' : '' }}">
                            <a href="#" class="nav-link">
                                <i class="nav-icon fas fa-swatchbook"></i>
                                <p>
                                    Other Pages
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                @foreach ($pages as $slug => $title)
                                    <li class="nav-item">
                                        <a href="{{ url('custom_pages/' . $slug) }}"
                                            class="nav-link {{ request()->is('custom_pages/' . $slug) ? 'active' : '' }}">
                                            <p class="">
                                                {{ $title }}
                                            </p>
                                        </a>
