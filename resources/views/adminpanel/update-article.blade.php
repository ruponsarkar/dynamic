    ...
    <div class="container">
        ...
        <form action="update-article-data/{{ $articles->id }}" method="post" enctype="multipart/form-data">
            ...
            <ul class="flex-outer">
                ...
                <li>
                    <label for="last-name">Article Type</label>
                    {{-- <input type="text" id="article_type" name="article_type" value="{{$articles->article_type}}"> --}}
                    <select name="article_type" id="article_type">
    

                        <option value="Original Research Article" {{ $articles->article_type == 'Original Research Article' ? 'selected' : '' }} >Original Research Article</option>
                        <option value="Review Article" {{ $articles->article_type == 'Review Article' ? 'selected' : '' }}>Review Article</option>
                        <option value="Case Report" {{ $articles->article_type == 'Case Report' ? 'selected' : '' }}>Case Report</option>
                        <option value="Short Communication" {{ $articles->article_type == 'Short Communication' ? 'selected' : '' }}>Short Communication </option>
                        <option value="Letter to editor" {{ $articles->article_type == 'Letter to editor' ? 'selected' : '' }}>Letter to editor</option>
